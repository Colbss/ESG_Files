...
public class Espresso_iSeq_1 {
    ...
    public void espresso_iSeq_1() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.button_parentheses), withText("( )"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.button_five), withText("5"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        3),
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.button_division), withText("÷"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        1),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textView_input_numbers), withText("20"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
